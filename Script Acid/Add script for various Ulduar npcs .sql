DELETE FROM `creature_ai_scripts` WHERE creature-id IN (33090, 33264, 34161, 33214, 33189, 33387, 34275, 33139, 33364, 33365, 33571, 34159, 33067, 33167, 33062, 33109, 33060);
